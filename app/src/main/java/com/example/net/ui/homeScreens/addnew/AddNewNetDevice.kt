...
@Composable
fun AddNewNetDevice(navController: NavController) {
    ...
    val addNetDevice: DevicesViewModel = hiltViewModel()

    val addNetDeviceFlow = addNetDevice.AddNetDeviceResponse.collectAsStateWithLifecycle()
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            Box(
                ...
                Row(
                    ...
                    Text(
                        text = "Add New Net Device", fontWeight = FontWeight.Bold,
                ...
                Button(
                    onClick = {
                        if (name.trim().equals("") || bloc.trim()
                            ...
                            val netDevice = NetDevices(name, type, bloc, parseInt(floor))
                            addNetDevice.addNetDevice(netDevice)
                        }
                    }, modifier = Modifier
                        .height(40.dp)
                        .width(150.dp),
